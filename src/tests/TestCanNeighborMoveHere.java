...
public class TestCanNeighborMoveHere {
	...
	public void testSimpleValidHorizontalToEastWithSizeTwoVehicleMovement() {
		vehiclesMap.put(carIdentifier, TestsUtils.getVehicle(carIdentifier, Constants.HORIZONTAL, 2, new Point(4, 3)));
		AStarSearchNode currentSearchNode = new AStarSearchNode(emptySpots, vehiclesMap, puzzleID, 1, 0, 0, calculator);
	...
	public void testSimpleValidHorizontalToEastWithSizeThreeVehicleMovement() {
		vehiclesMap.put(carIdentifier, TestsUtils.getVehicle(carIdentifier, Constants.HORIZONTAL, 3, new Point(1, 1)));
		AStarSearchNode currentSearchNode = new AStarSearchNode(emptySpots, vehiclesMap, puzzleID, 1, 0, 0, calculator);
	...
	public void testSimpleValidHorizontalToWestWithSizeTwoVehicleMovement() {
		vehiclesMap.put(carIdentifier, TestsUtils.getVehicle(carIdentifier, Constants.HORIZONTAL, 2, new Point(2, 2)));
		AStarSearchNode currentSearchNode = new AStarSearchNode(emptySpots, vehiclesMap, puzzleID, 1, 0, 0, calculator);
	...
	public void testSimpleValidHorizontalToWestWithSizeThreeVehicleMovement() {
		vehiclesMap.put(carIdentifier, TestsUtils.getVehicle(carIdentifier, Constants.HORIZONTAL, 3, new Point(0, 3)));
		AStarSearchNode currentSearchNode = new AStarSearchNode(emptySpots, vehiclesMap, puzzleID, 1, 0, 0, calculator);
	...
	public void testSimpleInValidHorizontalToWestWithSizeTwoVehicleMovement() {
		vehiclesMap.put(carIdentifier, TestsUtils.getVehicle(carIdentifier, Constants.HORIZONTAL, 2, new Point(5, 2)));
		AStarSearchNode currentSearchNode = new AStarSearchNode(emptySpots, vehiclesMap, puzzleID, 1, 0, 0, calculator);
	...
	public void testSimpleInValidHorizontalToWestWithSizeThreeVehicleMovement() {
		vehiclesMap.put(carIdentifier, TestsUtils.getVehicle(carIdentifier, Constants.HORIZONTAL, 3, new Point(2, 3)));
		AStarSearchNode currentSearchNode = new AStarSearchNode(emptySpots, vehiclesMap, puzzleID, 1, 0, 0, calculator);
	...
	public void testSimpleValidVerticalToNorthWithSizeTwoVehicleMovement() {
		vehiclesMap.put(carIdentifier, TestsUtils.getVehicle(carIdentifier, Constants.VERTICAL, 2, new Point(4, 5)));
		AStarSearchNode currentSearchNode = new AStarSearchNode(emptySpots, vehiclesMap, puzzleID, 1, 0, 0, calculator);
	...
	public void testSimpleValidVerticalToNorthWithSizeThreeVehicleMovement() {
		vehiclesMap.put(carIdentifier, TestsUtils.getVehicle(carIdentifier, Constants.VERTICAL, 3, new Point(1, 4)));
		AStarSearchNode currentSearchNode = new AStarSearchNode(emptySpots, vehiclesMap, puzzleID, 1, 0, 0, calculator);
	...
	public void testSimpleInValidVerticalToNorthWithSizeTwoVehicleMovement() {
		vehiclesMap.put(carIdentifier, TestsUtils.getVehicle(carIdentifier, Constants.VERTICAL, 2, new Point(3, 2)));
		AStarSearchNode currentSearchNode = new AStarSearchNode(emptySpots, vehiclesMap, puzzleID, 1, 0, 0, calculator);
	...
	public void testSimpleInValidVerticalToNorthWithSizeThreeVehicleMovement() {
		vehiclesMap.put(carIdentifier, TestsUtils.getVehicle(carIdentifier, Constants.VERTICAL, 3, new Point(0, 5)));
		AStarSearchNode currentSearchNode = new AStarSearchNode(emptySpots, vehiclesMap, puzzleID, 1, 0, 0, calculator);
	...
	public void testSimpleValidVerticalToSouthWithSizeTwoVehicleMovement() {
		vehiclesMap.put(carIdentifier, TestsUtils.getVehicle(carIdentifier, Constants.VERTICAL, 2, new Point(2, 0)));
		AStarSearchNode currentSearchNode = new AStarSearchNode(emptySpots, vehiclesMap, puzzleID, 1, 0, 0, calculator);
	...
	public void testSimpleValidVerticalToSouthWithSizeThreeVehicleMovement() {
		vehiclesMap.put(carIdentifier, TestsUtils.getVehicle(carIdentifier, Constants.VERTICAL, 3, new Point(2, 1)));
		AStarSearchNode currentSearchNode = new AStarSearchNode(emptySpots, vehiclesMap, puzzleID, 1, 0, 0, calculator);
